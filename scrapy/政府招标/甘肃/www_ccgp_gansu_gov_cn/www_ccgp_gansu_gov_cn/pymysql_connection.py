...
class pymysql_connection():
    ...
    def insert_into_doc(self, fields=None, values=None, ids=None, tablename=None, ddtable=None, str1='', str2='',
                        redis_field=None):
        ...
        try:
            ...
            if not select_result:
                ...
                if contenttype == 0:
                    ...
                    # reids断点
                    if redis_field != None:
                        self.conn_redis.del_data(field=redis_field, value=pageurl)
            else:
                print('---------已存在-------', sql)
                if redis_field != None:
                    self.conn_redis.del_data(field=redis_field, value=pageurl)
