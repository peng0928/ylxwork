...
class redis_conn():
    ...
    ##########断点续爬###########
    def set_add(self, field='政府招标链接集合:', value=None):
    ...
    def find_data(self, field='政府招标链接集合:', value=None):
        redis_pool = redis.ConnectionPool(host='10.0.2.248', port=6379, db=8)
        redis_conn = redis.Redis(connection_pool=redis_pool)
        result = redis_conn.sismember(field, value)
        return result
