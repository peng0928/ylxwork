...
class SpiderSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        'isPagination=true&pageHelp.pageSize=25'
        '&pageHelp.pageNo=1&pageHelp.beginPage=1&pageHelp.cacheSize=1&pageHelp.endPage=1&productId='
        f'&securityType=0101&reportType2=DQBG&reportType=ALL&beginDate={yesterday}&endDate={today}']
