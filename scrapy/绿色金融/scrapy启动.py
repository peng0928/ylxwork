...
def copy_file(area, projectName):
    shutil.copyfile('../../work_file/python-tools/pymysql_connection.py',
                    f'./{area}/{projectName}/{projectName}/pymysql_connection.py')
    shutil.copyfile('../../work_file/python-tools/data_process.py',
                    f'./{area}/{projectName}/{projectName}/data_process.py')
...
if __name__ == '__main__':
    area = '贵州'
    projectName = 'sthj.guizhou.gov.cn'
